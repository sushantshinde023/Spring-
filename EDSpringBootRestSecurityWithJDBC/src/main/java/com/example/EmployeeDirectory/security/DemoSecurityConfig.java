...
public class DemoSecurityConfig {
	...
	//instead of commented IN memory user creation logic we will be using Database user & authorities tables
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.csrf(csrf->csrf.disable());// for REST API it is not required as it is stateless
		return http.build();
